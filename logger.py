...
class LightLogging(object):
    def __init__(self, log_path=None, log_name='lightlog', log_level='debug', alpha = None,hop_num = None):
        ...
        if log_path:
            ...
            # log_name = log_path+log_name + '_' + args.dataset + '_' + args.gnn_type + '_alpha_' + str(alpha) + '_hop_num_' + str(hop_num) + '.log'
            log_name = log_path+log_name +'.log'
